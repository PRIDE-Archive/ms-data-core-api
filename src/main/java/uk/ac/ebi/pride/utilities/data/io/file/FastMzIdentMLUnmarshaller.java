...
public class FastMzIdentMLUnmarshaller {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FastMzIdentMLUnmarshaller.class);
    ...
    /**
     * This is the method should use to instantiate fastMzIdentMLUnmarshaller object.
     * This method is thread safe and also do a lazy loading because of two reasons:
     * 1. XML parsing from mzIdentML file is a memory intensive task
     * 2. MzIdentML is an object with high memory consumption
     *
    ...
    public static FastMzIdentMLUnmarshaller getInstance(File mzIdentMLFile) {
        try {
            ...
            logger.error("mzIdentML file access error : " + e.getMessage());
        }
        return fastMzIdentMLUnmarshaller;
    }
